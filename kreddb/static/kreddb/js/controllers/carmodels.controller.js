...
(function () {
  ...
  CarModelsController.$inject = ['$scope'];

  /**
  * @namespace CarModelsController
  */
  function CarModelsController($scope) {
    var vm = this;
    ...
    * @memberOf kreddb.controllers.CarModelsController
    */
    function activate() {
      $scope.$watchCollection(function () { return $scope.carmodels; }, render);
